...
struct FuncTID {
   ...
   public:
    void insert(std::string name, std::string return_type,
                func_parameters params);

    std::string get_return_type(std::string name) const;
    std::string get_return_type(std::string name,
                                std::vector<std::string> param_types) const;

    std::vector<std::pair<std::string, std::string>> get_parametrs(
        std::string name) const;

    std::map<std::string, std::pair<std::string, func_parameters>> get_funcs()
        const {
        return _functions;
    }
};
...
struct TypeTID {
   ...
   public:
    ...
    std::map<std::string, std::map<std::string, std::string>> get_types()
        const {
        return _types;
    }
};
...
class TID {
   ...
   public:
    ...
    std::string find_var(std::string name) const {
        return _vars.get_type(name);
    }
    std::string find_func(std::string name,
                          std::vector<std::string> param_types) const {
